...
ACLOCAL = ${SHELL} '/home/cam/mc-4.8.28/config/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} '/home/cam/mc-4.8.28/config/missing' autoconf
AUTOHEADER = ${SHELL} '/home/cam/mc-4.8.28/config/missing' autoheader
AUTOMAKE = ${SHELL} '/home/cam/mc-4.8.28/config/missing' automake-1.16
AWK = awk
CC = gcc
CCDEPMODE = depmode=none
CFLAGS =  -fdiagnostics-show-option -Wbad-function-cast -Wcomment -Wdeclaration-after-statement -Wfloat-conversion -Wfloat-equal -Wformat -Wformat-security -Wformat-signedness -Wimplicit -Wimplicit-fallthrough -Wignored-qualifiers -Wlogical-not-parentheses -Wmaybe-uninitialized -Wmissing-braces -Wmissing-declarations -Wmissing-field-initializers -Wmissing-format-attribute -Wmissing-parameter-type -Wmissing-prototypes -Wnested-externs -Wno-long-long -Wno-unreachable-code -Wparentheses -Wpointer-arith -Wpointer-sign -Wredundant-decls -Wreturn-type -Wsequence-point -Wshadow -Wsign-compare -Wstrict-prototypes -Wswitch -Wswitch-default -Wtype-limits -Wundef -Wuninitialized -Wunreachable-code -Wunused-but-set-variable -Wunused-function -Wunused-label -Wunused-parameter -Wunused-result -Wunused-value -Wunused-variable -Wwrite-strings  -g -O2 -ffile-prefix-map=/home/cam/mc-4.8.28=. -fstack-protector-strong -Wformat -Werror=format-security -march=native -mtune=native
...
DX_DVIPS = 
DX_EGREP = 
DX_ENV =  SRCDIR='/home/cam/mc-4.8.28' PROJECT='mc' DOCDIR='devel' VERSION='4.8.28' HAVE_DOT='NO' GENERATE_MAN='NO' GENERATE_RTF='NO' GENERATE_XML='NO' GENERATE_HTMLHELP='NO' GENERATE_CHI='NO' GENERATE_HTML='NO' GENERATE_LATEX='NO'
DX_FLAG_chi = 0
DX_FLAG_chm = 0
DX_FLAG_doc = 0
DX_FLAG_dot = 0
...
EXT2FS_LIBS = -lext2fs 
EXTHELPERSDIR = /usr/lib/mc/ext.d
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} '/home/cam/mc-4.8.28/config/missing' makeinfo
MANDOC = -mandoc
MANIFEST_TOOL = :
MAN_DATE = January 2023
MAN_FLAGS = -c -Tlatin1
MAN_VERSION = 4.8.28
MCLIBS = -lslang   -lgpm -le2p  -lssh2  -lext2fs  -lcom_err 
...
PACKAGE_STRING = GNU Midnight Commander 4.8.28
PACKAGE_TARNAME = mc
...
X_PRE_LIBS = 
ZIP = /usr/bin/zip
abs_builddir = /home/cam/mc-4.8.28
abs_srcdir = /home/cam/mc-4.8.28
abs_top_builddir = /home/cam/mc-4.8.28
abs_top_srcdir = /home/cam/mc-4.8.28
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/cam/mc-4.8.28/config/install-sh
